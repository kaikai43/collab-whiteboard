...
6. To run it on collaborative/distributed mode, run `java -cp target/pb3-0.0.1-SNAPSHOT-jar-with-dependencies.jar pb.WhiteboardServer` in a new terminal, then run `java -cp target/pb3-0.0.1-SNAPSHOT-jar-with-dependencies.jar pb.WhiteboardPeer -port <unique_4_digit_port_number>` in 2 new terminals (In total 3 terminals)
